...
if __name__ == "__main__":
    ...
    with open ("dictionary.txt", mode="r") as file1:
        for lines in file1:
            #print(lines)
            t = eval(lines)
            #print(t)
            ...
            try:
                    ...
                    spilt_non_join_copy = split_non_join
                    ...
                    print("count of good words      {}".format(goodwords))
                    print("*************************************")
                    #sleep(2)

                    split_non.remove(add_this)
